  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h3
          className={`${inter.className} text-sm font-semibold text-black dark:text-white leading-snug line-clamp-2`}
        >
          {item.title}
        </h3>
        {item.description && (
        ...
        <div className="flex items-center gap-2 mt-2 text-[10px] text-black/40 dark:text-white/40">
