          ...
          <div className="absolute inset-0 flex items-center justify-center z-60">
            <div className="bg-white/20 dark:bg-black/20 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
              <div className="flex items-center space-x-3">
                ...
                <span
                  className={`text-black dark:text-white ${roboto.className} text-lg font-medium`}
                >
                  Updating...
                </span>
              </div>
          ...
          <div className="relative bg-white/10 dark:bg-black/10 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="relative px-6 pt-6 pb-4">
              <div className="flex items-center justify-between">
                <h3
                  className={`${inter.className} text-xl font-semibold text-gray-900 dark:text-white`}
                >
                  Edit Audio
                </h3>
                <button
            ...
            <div className={`${roboto.className} relative px-6 pb-6 space-y-5`}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="Rap" className="bg-white dark:bg-gray-800">
                      Rap
                    </option>
                    <option
                      value="OldVibes"
                    ...
                    <option value="LK" className="bg-white dark:bg-gray-800">
                      LK
                    </option>
                    <option
                      value="FreeStyle"
            ...
            <div
              className={`${roboto.className} relative px-6 pb-6 flex flex-col sm:flex-row-reverse gap-3`}
            >
              <button
                type="button"
