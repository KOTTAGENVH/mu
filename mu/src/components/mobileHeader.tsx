...
function MobileHeader({ icon, btnNav, text }: MobileHeaderProps) {
  ...
  return (
    <div className="sticky top-0 flex justify-center">
      <nav className="flex items-center justify-between  bg-white bg-opacity-30 dark:bg-opacity-10 backdrop-blur-md p-2 w-4/5 m-4 rounded-full shadow-lg shadow-cyan-900/50 dark:shadow-cyan-100/20 hover:shadow-none">
        <div className="flex items-center justify-center flex-shrink-0 text-white md:mr-6">
          <motion.div
          ...
          >
            <button
            title="Refresh"
            className="flex text-black dark:text-white text-neutral-700 m-4 space-x-2 hover:bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... p-2 rounded-3xl shadow-lg shadow-cyan-900/50 dark:shadow-cyan-500/50 hover:shadow-none justify-center items-center">
              <FontAwesomeIcon
                icon={icon}
