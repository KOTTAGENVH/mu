...
function MobileOneAudioView({ idPass, name, category, favourite }: Audio) {
  ...
  return (
    <div className="w-full bg-white bg-opacity-10 backdrop-blur-xl shadow-lg rounded-3xl shadow-cyan-900/50 dark:shadow-cyan-500/50 hover:shadow-none dark:border-white h-20 p-4 flex justify-center items-center mt-8">
      <div className="w-full h-auto flex flex-row flewx-wrapjustify-center items-center text-black dark:text-white">
        {id === idPass && (
          <FontAwesomeIcon
            icon={faMusic}
...
export default MobileOneAudioView;
